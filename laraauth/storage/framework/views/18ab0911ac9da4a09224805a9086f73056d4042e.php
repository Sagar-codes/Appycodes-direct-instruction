            ...
            <?php if(Route::has('login')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('dashboard')); ?>" class="text-sm text-gray-700 underline">Home</a>
                    <?php else: ?>
...
<?php /**PATH C:\Users\user\Desktop\laravel projects\laraauth\resources\views/welcome.blade.php ENDPATH**/ ?>